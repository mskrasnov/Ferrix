...
about-blog = Блог:
about-author = (C) 2025, 2026 Михаил Краснов
...
bat-capacity = Уровень заряда
bat-estimated = Оставшееся время
bat-es-hours = час.
...
bat-volt-min-des = Мин. проектное напряжение, В
